...
import 'package:contact_cards/src/common/util/error_util.dart';
import 'package:contact_cards/src/feature/dependencies/initialization/initialize_dependencies.dart';
    ...
    void Function(Object error, StackTrace stackTrace)? onError,
      ...
      _$currentInitialization ??= Future<Dependencies>(() async {
        ...
        try {
          ...
          final dependencies = await $initializeDependencies(onProgress: notifyProgress).timeout(const Duration(minutes: 5));
